        ...
        <div className='h-screen bg-[#e5e4e4] flex flex-col justify-center items-center'>
            <div className='flex flex-col justify-center items-center gap-5'>
                ...
                <div role="status" className='s'>
                    <svg aria-hidden="true" className="w-12 h-12 text-gray-400 animate-spin dark:text-gray-600 fill-[#f0532d]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div>
                    <p className='text-sm italic font-poppins '>“ {randomQuote} ”</p>
                </div>
            </div>
        </div>
    );
