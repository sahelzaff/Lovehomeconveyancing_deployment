...
const ContactInfo = () => {
    return (
        <div>
            <section className="relative h-screen bg-fixed bg-center bg-cover bg-no-repeat" style={{ backgroundImage: `url(${assets.background})` }}>
                <div className="absolute inset-0 bg-[#bebebe] bg-opacity-70 flex flex-col items-start justify-center px-8">
