...
const Hero = () => {
  return (
    <div className="relative w-full h-screen bg-cover bg-center overflow-hidden" style={{ backgroundImage: `url(${assets.background})` }}>
      <div className="absolute inset-0 flex flex-col items-center md:items-start justify-center text-white px-6 md:px-14 pb-20 z-40 xl:pt-28">
        ...
        <div className='relative h-8 w-full mt-4'>
          <div className="absolute inset-0 bg-[#0086C3] h-full" id='left_full' ></div>
          <div className="relative flex items-center justify-center h-full" id='letter'>
            <p className="text-lg md:text-2xl px-6 mb-8 pt-10 text-center font-poppins font-normal text-white">
              Get a Tailored Conveyancing Quote in Minutes!
            </p>
          </div>
        </div>

        <div className='relative h-8 w-full mt-24'>
          <div className="absolute inset-0 bg-[#0086C3] h-full" id='left_half'></div>
          <div className="relative flex items-center justify-center h-full" id='letter2'>
            <p className="text-lg md:text-2xl mb-3 px-6 pt-5 text-center font-roboto">Property Conveyancing</p>
          </div>
        </div>

        <div className="flex flex-col md:flex-row items-center pt-4 space-y-4 md:space-y-0 md:space-x-4">
          <CustomSelect
